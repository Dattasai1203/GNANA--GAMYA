...
==================================================
Launches all Nav2 nodes: controller_server, smoother_server,
planner_server, behavior_server, bt_navigator, waypoint_follower,
velocity_smoother, and lifecycle_manager.

Supports both standard nodes and composable nodes (use_composition).

Usage:
  ros2 launch gnanagamya navigation_launch.py
...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument('container_name',
